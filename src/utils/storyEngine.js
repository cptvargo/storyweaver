...
import larryAndJonathanMeta from '../data/books/larryAndJonathan/bookMeta.json'

// All available books. Add new entries here as the library grows.
const ALL_BOOKS = [whereWeFirstMetMeta, firefliesBetweenUsMeta, undertowMeta, larryAndJonathanMeta]
